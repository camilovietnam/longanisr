...
alias cls='clear'
alias cd..='cd ..'
alias eee='gedit $LONG_PATH/aliases.sh && . $LONG_PATH/aliases.sh'
alias ll='ls -lF'
alias la='ls -A'
alias l='ls -CF'
...
alias editkeys='gedit ~/.xbindkeysrc'
alias editgovernor='sudo gedit /etc/default/tlp'
alias eng='setxkbmap us'
alias esp='setxkbmap es'
alias egovernor='sudo gedit /etc/default/tlp'
...
alias editwallpaper='sudo gedit /usr/share/gnome-shell/theme/ubuntu.css'
...
alias remap='sudo gedit /usr/share/X11/xkb/symbols/pc'
